...
<body>
	...
	<div id="align-button">
	<form:form action="/forest/fight/${monster.id}/" method="post" modelAttribute="hero">
	<input type="hidden" name="_method" value="put">
	<form:input type="hidden" name="user" path="user"/>
	<input id="logout-button" class="input" class="button" type="submit" value="Ready to Fight ${monster.name}"/>
	</form:form>
	</div>
